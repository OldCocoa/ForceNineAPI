...
You will need to grab manifest.json from `/var/mobile/Containers/Data/Application/(Discord UUID)/Documents/RCTAsyncLocalStorage_V1/` and add token and email_cache properties to the end of the JSON file, like in this JSON example.
